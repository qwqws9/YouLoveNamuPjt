	...
	<div class="col-10 col-md-10 col-lg-10">
		<div class="row">
			<div class="col-2 col-md-2 col-lg-2" style="top: 8px;">
				<h5><strong style="font-style: inherit;" >Community</strong></h5>
			</div>
			...
			<div class="col-md-10">
				<div class="row">
					<c:forEach var="best" items="${list}" begin="0" end="2">
						<div class="col-md-4">
							<div class="card" id="bestCommunity" style="width: 350px; cursor: pointer;">
								<input type="hidden" id="communityCode" name="communityCode" value="${best.communityCode}"/>
			...
			<div class="col-10 col-md-10">
				<div class="row">
					...
					<div class="col-lg-4 offset-lg-2">
						<div class="row float-right" >
							<div class="col mr-3">
							<select id="searchSelect" class="selectpicker" multiple data-actions-box="true" title="All" style="border: 1px solid #ff7d75; background: white;">
				...
				<div class="row">
					<div class="col-2 col-md-2" style="top: 30px;">
						<input type="hidden" id="communityCodelist" name="communityCode" value="${community.communityCode}"/>
						<p class="text-center" style="font-size:x-small; color:#344157;">No.${community.communityCode}</p>
						...
						<p class="text-center" style="font-size:x-small; color:#344157;">[${community.city}]</p>
						</c:if>
					</div>
					<div class="col-7 col-md-7">
						<div class="row" id="profile-box" style="position: relative;">
							...
							<div id="profile-nickname" style="position: absolute; top: 10px; left: 52px; ">
								<div style="font-size:x-small; color:#3c64a6;">
									글쓴이
								</div>
						...
						<div class="row">
							<div class="getCommunity content" style="overflow:hidden; text-overflow: ellipsis; height: 50px; cursor: pointer;">
								<p style="resize: none; display: inline-blocke">
					...
					<div class="col-3 col-md-3">
						<img alt="" class="getCommunity image" src="/resources/images/ThumbNail/${community.communityThumbnail }" width="250px" height="160px" style="border-radius: 6px;  cursor: pointer;">
					</div>
				</div>
				<hr>
				</c:forEach>
	...
	<div class="col-1 col-md-1">
		<div class="row">
			<div class="col" style="position: fixed; bottom: 30px;">
				<button type="button" id="addCommunity" style="border-radius:30px; border:2px dashed #ff7d75; background:none; width: 60px; height: 60px;">
					<i class="fas fa-pencil-alt fa-2x" style="color:#ff7d75; width: 30px; height: 30;"></i>
				</button>
			</div>
		</div>
	</div>
