...
<!-- 							</div> -->
					...
					<div class="col-10 col-md-10 append">
						<c:forEach var="community" items="${list}">
							<div class="row justify-content-center list" id="no">
								<div>
									<img class="getCommunity image" name="thumbnail" src="/resources/images/ThumbNail/${community.communityThumbnail }" style="cursor: pointer;">
