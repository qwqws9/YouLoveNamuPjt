...
<div class="container-fluid col-10">
	...
	<div class="row">
		...
		<h4 style="resize: none; display: inline-blocke">
			<strong>제목&nbsp;&nbsp;</strong>
			<small style="font-size: xx-small;">19.06.29 16:28&nbsp;&nbsp;</small>
		</h4>
		</div>
	</div>
		...
		<div class="col-12">
			<div class="row" id="profile" style="position: relative; ">
				<div class="col-1 order-1" id="profile-image">
					<a href="#"><img src="../images/dog.JPG"  class="rounded-circle" id="userImage" name="userImage" alt="글쓴이" width="45px" height="45px"></a>
				</div>
	...
	<div class="row">
		...
		<div class="col-3 offset-3" align="right">
			<span style="font-size: 10px">관련글 더보기</span>
		</div>
	</div>
	...
	<div class="row" align="center">
		<div class="col-3">
		<a href="#"><img src="../images/dog.JPG" id="bbsImage1" name="userImage" alt="글쓴이" class="" width="230px" height="150px" style="border-radius: 6px;"></a>
		</div>
		<div class="col-3">
		<a href="#"><img src="../images/dog.JPG" id="bbsImage2" name="userImage" alt="글쓴이" class="" width="230px" height="150px" style="border-radius: 6px;"></a>
		</div>
		<div class="col-3">
			<a href="#"><img src="../images/dog.JPG" id="bbsImage3" name="userImage" alt="글쓴이" class="" width="230px" height="150px" style="border-radius: 6px;"></a>
		</div>
		<div class="col-3">
			<a href="#"><img src="../images/dog.JPG" id="bbsImage4" name="userImage" alt="글쓴이" class="" width="230px" height="150px" style="border-radius: 6px;"></a>
		</div>
	</div>
